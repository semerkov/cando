...
public class CalendarServlet extends HttpServlet {
    ...
    private static final List<String> SECURITY_ACTIONS = Arrays
            .asList("retrieveCalenderTable","viewDayCalendar","retrieveCalenderWeek", "addCalendar",
                    "retrieveEventCalendarMenu", "removeCalendar",
                    "updateCalendar", "addEvent", "updateEvent", "removeEvent",
                    "viewEvent", "getEvent", "viewTasks", "addTask", "removeTask", "updateTask",
                    "changeTaskState" );
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        } else if(action.equals("viewDayCalendar")) {
